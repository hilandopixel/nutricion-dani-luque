...
export let translations = {
  es: {
    ...
    where_title: "Subbética y en cualquier lugar",
    where_subtitle: "Presencial y Online",
    where_p1: "Ubicada en el núcleo de Priego de Córdoba, presencialmente con pacientes del área de Lucena, Cabra, Priego de Córdoba, Rute, Baena, Montilla y el resto de municipios que conforman La Subbética Cordobesa.",
    where_p2: "¿Vives fuera de la comarca? Tienes la opción de realizar el seguimiento completo a través de nuestra plataforma online con idénticos resultados de éxito.",
  ...
  en: {
    ...
    where_title: "Subbética & Anywhere",
    where_subtitle: "In-Person and Online",
    where_p1: "Located in Priego de Córdoba, working in-person with clients from Lucena, Cabra, Priego, Rute, Baena, Montilla, and the rest of Subbética Cordobesa.",
    where_p2: "Do you live outside the region? You can choose full online monitoring with the exact same successful results.",
